...
int GuiMain(drawcallback drawfunction, void* obj_ptr)
{
    ...
    ImFont* font = io.Fonts->AddFontFromFileTTF("C:\\program files (x86)\\Microsoft Office\\root\\vfs\\Fonts\\private\\BERNHC.TTF", 18.0f, nullptr, &ranges[0]);
    IM_ASSERT(font != nullptr);

    // Our state
    ImVec4 clear_color = ImVec4(0.5f, 0.7f, 1.0f, 1.0f); // Light Blue
    // Main loop
    bool done = false;
    while (!done)
    {
